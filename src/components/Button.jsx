export default function Button({ icon, text, className, href }) {
  ...
  const content = (
    <>
      ...
      <p className="font-outfit pr-5 pl-15 text-base leading-normal font-medium whitespace-nowrap text-black not-italic transition-transform duration-300 ease-out group-hover:translate-x-1 md:text-xl">
        {text}
      </p>
    </>
  );
